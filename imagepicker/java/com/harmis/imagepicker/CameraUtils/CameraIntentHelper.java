...
public class CameraIntentHelper {
     ...
     * constant REQUEST_IMAGE_CODE. We do NOT set any other intent extras.
     * <p>
     ...
     */
    public void startCameraIntent(int REQUEST_IMAGE_CODE) {
...
//				String sdkVersion = android.os.Build.VERSION.RELEASE.toLowerCase(Locale.ENGLISH);
    ...
    private void onCameraIntentResult(int requestCode, int resultCode, Intent intent) {
        if (resultCode == Activity.RESULT_OK) {
            ...
            if (photoUri != null) {
                onPhotoUriFound( requestCode );
            } else {
                onPhotoUriNotFound( requestCode );
            }
     ...
     */
    private void onPhotoUriFound(int requestCode) {
        if (mCameraIntentHelperCallback != null) {
            mCameraIntentHelperCallback.onPhotoUriFound( requestCode, dateCameraIntentStarted, photoUri, rotateXDegrees );
        }
    }
     ...
     */
    private void onPhotoUriNotFound(int requestCode) {
        if (mCameraIntentHelperCallback != null) {
            mCameraIntentHelperCallback.onPhotoUriNotFound( requestCode );
        }
    }
